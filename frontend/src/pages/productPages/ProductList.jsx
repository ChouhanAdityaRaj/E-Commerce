...
function ProductList() {
  ...
  const handleFilter = () => {
    ...
    let url = `/product?search=${queryString.search}`
      ...
      <div className="pt-7">
        ...
        <div className="px-4 md:px-8 lg:px-16 py-8">
          ...
          <div className="text-sm text-gray-500 mb-4">
            <span className="mx-1">CLOTHING</span> /
            <span className="mx-1">{queryString.search}</span>
          </div>

          {/* Title */}
          <h1 className="text-4xl font-bold mb-6 ">{queryString.search}</h1>
